...
function getModelUrlByType(type) {
  const modelMap = {
    HUAV: '/models/HUAV.glb',      // 高空无人机
    MUAV: '/models/MUAV.glb',      // 中空无人机
    CCV: '/models/CCV.glb',        // 无人通信艇
    IFV: '/models/IFV.glb',        // 步兵战车
    Warship: '/models/Warship.glb', // 战舰
    SATCOM: '/models/SATCOM.glb',  // 卫星通信设备
    Satellite: '/models/Satellite.glb', // 卫星
  };
